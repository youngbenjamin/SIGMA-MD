...
global.owner = process.env.OWNER_NUMBER  || '+256761505083' ;  // ADD YOUR NUMBER WITHOUT +
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || ''15_05_2024_SIGMA_MD_zApZwFnV_MAHER_ZUBAIR              // PUT YOUR SESSION ID
